...
#    ct.G, kap, ct.pi, ct.a, ct.c, ct.gamma, eps = q
    ...
    dTdr_1=((3*kap*p*L)/(16*ct.pi*ct.a*ct.c*(T**3)*(r**2)))
    dTdr_2=(1-1/ct.gamma)*(T/P)*(ct.G*M*p/r**2)
    print "dTdr_1=", dTdr_1
    print "dTdr_2=", dTdr_2
...
r = np.linspace(0.0001, ct.R_s, 1000)  
y0 = [p_c,T_c, M, L, 1.0e6]
